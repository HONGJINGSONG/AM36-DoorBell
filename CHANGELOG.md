...
All notable changes to AM36 Electronic Doorbell are documented in this file.

The project follows [Semantic Versioning](https://semver.org/).

## [1.0.0] - 2026-09-21

- Prepared the initial public source release for the Lierda
  L-LRMAM36-FANN4-DK01 development kit.
- Added door-station and display-gateway roles in one firmware image.
